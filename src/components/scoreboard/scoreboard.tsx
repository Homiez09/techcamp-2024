                                    ...
                                    </div>
                                {
                                    selectedTeam[index] && (
                                        <>
                                            <li
                                                key={team.teamID}
                                                className='flex flex-col w-full text-gray-200 rounded-xl text-xs md:text-sm transition-all duration-[1000] py-[1vh] pr-[33px]'
                                            >
                        ...
                        {teams.length === 0 &&  (
                            <>
                                {Array(20).fill(0).map((_, index) => (
                                   <li
                                        key={index}
                                        className='flex flex-col w-full text-gray-200 justify-between bg-primaryBlue bg-opacity-6021 hover:bg-opacity-90 hover:bg-gray-700 rounded-xl text-sm md:text-base lg:text-lg transition-all duration-[2000] cursor-pointer'
                                    >
                                        <div className='w-full transition-all duration-1000 px-[2vw] py-[2vh]'> 
                                            <Skeleton
                                                active              
                                            />
                                        </div>
